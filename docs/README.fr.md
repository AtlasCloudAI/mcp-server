...
- 🎬 **Vidéo** (215) — MiniMax H3 Max · MiniMax H3 Fast · Gemini Omni 1.1 Flash · MiniMax H3 · Wan-3.0-Prime · Wan-3.0
...
- 🔊 **Audio (TTS · Musique · ASR)** (13) — Seed Audio 1.0 · MiniMax Speech 2.6 Turbo · MiniMax Speech 2.6 HD · xAI TTS v1

- 📚 **Explorer plus** — [les 472 modèles en ligne »](https://www.atlascloud.ai/models?utm_source=github&utm_campaign=mcp-server)
<!-- ATLAS-MODELS:END -->
...
- 🎬 **« Transforme cette photo de produit en publicité de 5 secondes »** — image-vers-vidéo avec Seedance 2.5, Kling 3, Kling Video O3, Veo 3.1…
