...
- 🎬 **Vidéo** (181) — MiniMax H3 · Youchuan V8.2 · Wan 2.7 Spicy · Seedance 2.0 Mini · HappyHorse-1.1 · Gemini Omni Flash
...
- 🔊 **Audio (TTS · Musique · ASR)** (11) — Seed Audio 1.0 · xAI TTS v1 · ElevenLabs v3 · Gemini 3.1 Flash TTS

- 📚 **Explorer plus** — [les 385 modèles en ligne »](https://www.atlascloud.ai/models?utm_source=github&utm_campaign=mcp-server)
<!-- ATLAS-MODELS:END -->
