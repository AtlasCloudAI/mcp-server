...
- 🎬 **视频** (200) — MiniMax H3 Max · MiniMax H3 Fast · Gemini Omni 1.1 Flash · MiniMax H3 · Wan-3.0-Prime · Wan-3.0
- 🎨 **图片** (126) — GPT Image 2.5 Sunburst · GPT Image 2.5 Flare · Seedream v4.7 · MAI-Image-2.5-Pro
- 🧊 **3D** (7) — Seed3D 2.0 · Tripo H3.1 · Hunyuan 3D Rapid · Hunyuan 3D Pro
- 💬 **大语言模型** (70) — DeepSeek V4 Pro 0813 · Grok 4.6 · DeepSeek V4 Flash Vision Exp · DeepSeek V4 Flash 0731
- 🔊 **音频（TTS · 音乐 · 语音识别）** (17) — Suno chirp-v4-5-all · Suno chirp-v4-5-plus · Suno chirp-auk · Suno chirp-fenix

- 📚 **探索更多** — [全部 443 个在线模型 »](https://www.atlascloud.ai/models?utm_source=github&utm_campaign=mcp-server)
<!-- ATLAS-MODELS:END -->
...
底层能力包括：模型发现、每个模型的动态参数 Schema（在每次请求前校验，无效参数会快速失败而不消耗额度；每个生成工具还支持 `dry_run`，只展示将要发出的请求体而不提交）、媒体上传、一步式快速生成、账户余额与用量查询、以及文档搜索 —— 全部以标准 MCP 工具的形式提供（详见 [可用工具](#可用工具)）。
